  ...
  return (
    <div className={"pb-24"}>
      <div className="mx-auto max-w-7xl">
        ...
        <dl className="mx-auto mt-8 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 md:gap-y-16 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
