      ...
      <Prose>
        ...
        <section>
          ...
          <p>
            ...
            naszych usług czuł się komfortowo. Dlatego też poniżej prezentujemy
            Ci najważniejsze informacje o zasadach przetwarzania przez nas
            Twoich danych osobowych oraz plikach cookies, które są
            wykorzystywane przez nasz Sklep. Informacje te zostały przygotowane
            z uwzględnieniem RODO, czyli ogólnego rozporządzenia o ochronie
            danych.
          </p>
        </section>
        <section>
          ...
          <p>
            Daniel Noworyta, przedsiębiorca prowadzący działalność gospodarczą
            pod firmą Daniel Noworyta, wpisany do Centralnej Ewidencji i
            Informacji o Działalności Gospodarczej prowadzonej przez ministra
            właściwego do spraw gospodarki i prowadzenia Centralnej Ewidencji i
            Informacji o Działalności Gospodarczej, NIP 6262908784, nr REGON
            380674327, Armi Krajowej 7/30, Tarnowskie Góry 42-609.
          </p>
          <p>
        ...
        <section>
          ...
          <ul>
            <li>
              ...
              danych (art. 15 RODO lub - jeśli ma to zastosowanie - art. 13 ust.
              1 lit. f RODO),
            </li>
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  art. 6 ust. 1 lit. f RODO (tj. na realizowanych przez nas
                  prawnie uzasadnionych interesach) (art. 21 ust. 1 RODO);
                </li>
                <li>
        ...
        <section>
          ...
          <p>
            W ramach strony internetowej Sklepu prowadzimy działania
            ...
            pod uwagę sposób, w jaki poruszasz się po Sklepie – a więc np. to,
            ile czasu spędzasz na danej podstronie, czy w które miejsca w
            Sklepie klikasz. Dzięki temu podczas prac nad rozwojem Sklepu
            będziemy mogli zoptymalizować jego układ, wygląd oraz zamieszczane w
            nim treści, tak aby polepszyć jego funkcjonalność.
          </p>
          <p>
            Ponadto, jeśli wyrazisz wolę otrzymywania od nas newslettera, możemy
            dokonywać analizy efektywności przeprowadzonej przez nas wysyłki.
            Przykładowo, możemy sprawdzić, czy i w jaki sposób wpłynęła ona na
            aktywność w naszym Sklepie. Takie działania pomogą nam ustalić
            ogólne zasady dotyczące wysyłki tego typu wiadomości w naszej
            działalności - np. w zakresie optymalnych godzin wysyłki czy sposobu
            formułowania skutecznych treści.
          </p>
        </section>
        <section>
        ...
        <section>
          <h2>PLIKI COOKIES</h2>
          <p>
            Nasz Sklep, jak większość witryn internetowych, korzysta z tzw.
          ...
          <ul>
            ...
            <li>
              <a
                href="https://support.mozilla.org/pl/kb/elementy-sledzace-zewnetrznych-witryn"
                target="_blank"
              >
                Mozilla Firefox
              </a>
          ...
          <p>
            Pliki cookies nie będą przetwarzane przez nas dłużej niż 60 minut od
            ostatniej wizyty w Sklepie.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            prowadzeniu działalności. Powierzamy im do przetwarzania Twoje dane
            – podmioty te przetwarzają dane wyłącznie na nasze udokumentowane
            polecenie.{" "}
          </p>
