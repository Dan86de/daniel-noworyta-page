      ...
      <div className="grid grid-cols-1 gap-y-2 gap-x-4 lg:grid-cols-2 lg:grid-rows-[auto_1fr]">
        <Prose>
          ...
          <p>
            ...
            ten prosty formularz. Obiecuję, że{" "}
          ...
          <p>
            ...
            wykorzystał Twoją opinię w celach promocyjnych. Jeżeli chcesz, dodaj
            link do Twojej strony, to pozwoli Ci dotrzeć do nowych osób. A
            jeżeli dorzucisz do tego swoje zdjęcie, to już w ogóle będę
            zachwycony. 🙂
          </p>
          ...
          <div className={"w-full flex align-baseline justify-end mt-24"}>
            <div className={"flex-col"}>
              <div className={"-my-8 mx-4 flex-col pb-6"}>
                <p
                  className={"text-zinc-900 dark:text-zinc-100 m-0 font-medium"}
                >
                  Daniel Noworyta
                </p>
                <p
